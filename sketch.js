...
function setup(){
  ...
  bg= createSprite(displayWidth/2,displayHeight/2-150,displayWidth,displayHeight);
  bg.addImage(bgImg);
  bg.scale = 1.15;
   ...
   hand.addImage(hImg);
   hand.scale=0.25;
   plastic =createSprite(random(200,700),displayHeight-175);
   plastic.addImage(pimg);
  
   kWaste= createSprite(random(200,700), displayHeight-175);
  kWaste.addImage(kImg)
  kWaste.scale = 0.5
   ground = createSprite(200, 790, 400, displayHeight-175);
  
  wetGroup = createGroup();
  dryGroup = createGroup();

   green1 = createSprite(225, displayHeight-175);
   green1.addImage("green1",greenImg)
   green1.scale = 0.4
  
   blue = createSprite(100, displayHeight-175);
   blue.addImage("blue",blueImg)
   blue.scale = 0.4
  
   wpaper = createSprite(random(200,700), displayHeight-175, 1, 1);
   wpaper.addImage("np",npImg)
   wpaper.scale = 0.125
  
   sand = createSprite(random(200,700), displayHeight-175);
   sand.addImage("s",sImg)
   sand.scale = 0.15
  
   banana = createSprite(random(200,700), displayHeight-175);
   banana.addImage("b",bImg)
   banana.scale = 0.15
  
   apple = createSprite(random(200,700), displayHeight-175); 
